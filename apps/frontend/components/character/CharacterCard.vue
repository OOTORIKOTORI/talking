<template>
  <article class="relative block rounded-2xl overflow-hidden bg-white ring-1 ring-black/5 shadow-sm hover:shadow-md transition">
    <NuxtLink :to="`/characters/${character.id}`" class="block group">
    ...
    <div class="p-3">
      <div class="font-semibold line-clamp-1">
        <NuxtLink :to="`/characters/${character.id}`" class="hover:underline">
