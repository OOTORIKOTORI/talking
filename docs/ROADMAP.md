...
> 最終更新: 2026-05-07（公開後参照追加・削除の厳密運用MVP、公開前確認画面からの編集導線強化MVP、共通ヘッダースマホ対応MVP、公開中編集時の注意バナーMVP、公開中編集バナー折りたたみMVP）
